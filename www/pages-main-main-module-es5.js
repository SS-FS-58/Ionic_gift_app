  ...
  function srcAppPagesMainMainPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function MainPage(r, service) {
        ...
        this.service.getMainCategories().subscribe(function (res) {
          _this.main_cat = res.result;
          console.log('fsdfdsf', _this.main_cat);

          _this.getPro(2);

          console.log(_this.main_cat[0].id);
        }, function (err) {});
      }
      ...
      _createClass(MainPage, [{
        ...
        key: "price",
        value: function price(p, img, name) {
          var card_detail = {
            card_name: name,
            card_img: img
          };
        ...
        key: "getPro",
        value: function getPro(e) {
          var _this2 = this;

          this.service.presentLoading();
          this.service.getCategorie(e).subscribe(function (res) {
            console.log(res);

            if (res.status == '1') {
              _this2.resArry = res.result;
              _this2.resArryLoaded = res.result;
            } else {
              _this2.resArry = [];
            }
          }, function (err) {
        ...
        value: function getItems(searchbar) {
          ...
          this.resArry = this.resArry.filter(function (v) {
            if (v.sub_cat_name && q) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])], MainPage);
    /***/
  }
}]);
