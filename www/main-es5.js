...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      "./pages/add-profile/add-profile.module": ["./src/app/pages/add-profile/add-profile.module.ts", "common", "pages-add-profile-add-profile-module"],
      "./pages/bank-card/bank-card.module": ["./src/app/pages/bank-card/bank-card.module.ts", "pages-bank-card-bank-card-module"],
      "./pages/card-detail/card-detail.module": ["./src/app/pages/card-detail/card-detail.module.ts", "pages-card-detail-card-detail-module"],
      "./pages/checkout/checkout.module": ["./src/app/pages/checkout/checkout.module.ts", "common", "pages-checkout-checkout-module"],
      "./pages/contact/contact.module": ["./src/app/pages/contact/contact.module.ts", "pages-contact-contact-module"],
      "./pages/edit-profile/edit-profile.module": ["./src/app/pages/edit-profile/edit-profile.module.ts", "common", "pages-edit-profile-edit-profile-module"],
      "./pages/extra-categories/extra-categories.module": ["./src/app/pages/extra-categories/extra-categories.module.ts", "pages-extra-categories-extra-categories-module"],
      "./pages/forgot/forgot.module": ["./src/app/pages/forgot/forgot.module.ts", "common", "pages-forgot-forgot-module"],
      ...
      "./pages/main/main.module": ["./src/app/pages/main/main.module.ts", "common", "pages-main-main-module"],
      "./pages/mycard/mycard.module": ["./src/app/pages/mycard/mycard.module.ts", "pages-mycard-mycard-module"],
      "./pages/navigation/navigation.module": ["./src/app/pages/navigation/navigation.module.ts", "pages-navigation-navigation-module"],
      "./pages/notification/notification.module": ["./src/app/pages/notification/notification.module.ts", "pages-notification-notification-module"],
      "./pages/paymnet/paymnet.module": ["./src/app/pages/paymnet/paymnet.module.ts", "pages-paymnet-paymnet-module"],
      "./pages/paypal/paypal.module": ["./src/app/pages/paypal/paypal.module.ts", "pages-paypal-paypal-module"],
      "./pages/profile/profile.module": ["./src/app/pages/profile/profile.module.ts", "pages-profile-profile-module"],
      "./pages/received-card/received-card.module": ["./src/app/pages/received-card/received-card.module.ts", "pages-received-card-received-card-module"],
      "./pages/signup/signup.module": ["./src/app/pages/signup/signup.module.ts", "common", "pages-signup-signup-module"],
      "./pages/summary/summary.module": ["./src/app/pages/summary/summary.module.ts", "pages-summary-summary-module"]
    };
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    {
      path: 'add-profile',
      loadChildren: './pages/add-profile/add-profile.module#AddProfilePageModule'
    }, {
      path: 'card-detail/:price',
      ...
      path: 'mycard',
      loadChildren: './pages/mycard/mycard.module#MycardPageModule'
    }, {
      path: 'navigation',
      ...
      path: 'paymnet',
      loadChildren: './pages/paymnet/paymnet.module#PaymnetPageModule'
    }, {
      path: 'paypal',
      loadChildren: './pages/paypal/paypal.module#PaypalPageModule'
    }, {
      path: 'profile',
      loadChildren: './pages/profile/profile.module#ProfilePageModule'
    }, {
      path: 'received-card',
      loadChildren: './pages/received-card/received-card.module#ReceivedCardPageModule'
    }, {
      path: 'signup',
      ...
      loadChildren: './pages/extra-categories/extra-categories.module#ExtraCategoriesPageModule'
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_native_ionic_webview_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    var _ionic_native_stripe_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @ionic-native/stripe/ngx */
    "./node_modules/@ionic-native/stripe/ngx/index.js");
    /* harmony import */


    var _ionic_native_base64_ngx__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_10__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_6__["SplashScreen"], _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_11__["File"], _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_12__["FileTransfer"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_13__["Camera"], _ionic_native_ionic_webview_ngx__WEBPACK_IMPORTED_MODULE_14__["WebView"], _ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_15__["FilePath"], _ionic_native_stripe_ngx__WEBPACK_IMPORTED_MODULE_16__["Stripe"], _ionic_native_base64_ngx__WEBPACK_IMPORTED_MODULE_17__["Base64"], _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_18__["GooglePlus"], {
