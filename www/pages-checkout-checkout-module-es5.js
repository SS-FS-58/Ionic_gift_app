...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-checkout-checkout-module"], {
  ...
  function srcAppPagesCheckoutCheckoutPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function CheckoutPage(fileTransfer, r, stripe, service) {
      ...
      _createClass(CheckoutPage, [{
        ...
        value: function call() {
          ...
          this.service.sendCard(obj, this.imag1Obj, this.imag2Obj).subscribe(function (res) {
            _this.firstResObj = res.result;
            _this.id = _this.firstResObj.id;

            _this.service.presentToast('Pyment Successfull'); //this.goto('main');
