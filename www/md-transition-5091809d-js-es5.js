(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["md-transition-5091809d-js"], {
  ...
  /***/
  function node_modulesIonicCoreDistEsmMdTransition5091809dJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var mdTransitionAnimation = function mdTransitionAnimation(_, opts) {
      ...
      if (leavingEl && backDirection) {
        ...
        leavingPage.addElement(getIonPageElement(leavingEl)).afterStyles({
          'display': 'none'
