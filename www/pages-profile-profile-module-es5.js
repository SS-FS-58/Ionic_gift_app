  ...
  function srcAppPagesProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ProfilePage(r) {
        ...
        this.option = [{
          head: 'Privacy Policy',
          sub_head: 'Read our privacy ploicy',
          goto: ''
        }, {
          head: 'Terms and conditions',
          sub_head: 'Read our terms and conditions',
          goto: ''
        }, {
          head: 'Contact support',
          sub_head: 'We are ready to assist you',
          goto: ''
        }, {
          head: "FAQ's",
          sub_head: 'frequently asked questions',
          goto: ''
        }];
        this.userData = {};
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], ProfilePage);
    /***/
  }
}]);
